...
CtpDataServer::~CtpDataServer(void)
{
	//TODO:
...
void CtpDataServer::OnMarketPrice(BaseTick* tick)
{
...
bool  CtpDataServer::InitTcp(std::string& err)
{
/*
	...
	if (NULL == tick_tcp_server_)
	{
		...
		tick_tcp_server_ = new TickTcpServer(TcpServer_port);
...
bool CtpDataServer::StartUp(bool is_day, std::string& err)
{
...
void CtpDataServer::DoAfterMarket(bool is_day)
{
	if (NULL != m_market_api)
	{
		std::string err;
