...
static const char qt_meta_stringdata_QPropertyAnimation[] = {
    "QPropertyAnimation\0QByteArray\0"
    "propertyName\0QObject*\0targetObject\0"
};
...
const QMetaObjectExtraData QPropertyAnimation::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QPropertyAnimation::staticMetaObject = {
    { &QVariantAnimation::staticMetaObject, qt_meta_stringdata_QPropertyAnimation,
      qt_meta_data_QPropertyAnimation, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QPropertyAnimation::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPropertyAnimation))
...
int QPropertyAnimation::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        ...
        case 1: *reinterpret_cast< QObject**>(_v) = targetObject(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setPropertyName(*reinterpret_cast< QByteArray*>(_v)); break;
        case 1: setTargetObject(*reinterpret_cast< QObject**>(_v)); break;
        }
        _id -= 2;
