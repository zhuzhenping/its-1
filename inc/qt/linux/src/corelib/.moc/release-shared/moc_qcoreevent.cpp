...
static const uint qt_meta_data_QEvent[] = {
 ...
 // enum data: key, value
    ...
    2305, uint(QEvent::MacGLClearDrawable),
    2324, uint(QEvent::StateMachineSignal),
    2343, uint(QEvent::StateMachineWrapped),
    2363, uint(QEvent::TouchBegin),
    2374, uint(QEvent::TouchUpdate),
    2386, uint(QEvent::TouchEnd),
    2395, uint(QEvent::NativeGesture),
    2409, uint(QEvent::RequestSoftwareInputPanel),
    2435, uint(QEvent::CloseSoftwareInputPanel),
    2459, uint(QEvent::UpdateSoftKeys),
    2474, uint(QEvent::WinIdChange),
    2486, uint(QEvent::Gesture),
    2494, uint(QEvent::GestureOverride),
    2510, uint(QEvent::PlatformPanel),
    2524, uint(QEvent::User),
    2529, uint(QEvent::MaxUser),
...
static const char qt_meta_stringdata_QEvent[] = {
    ...
    "PlatformPanel\0User\0MaxUser\0"
};
