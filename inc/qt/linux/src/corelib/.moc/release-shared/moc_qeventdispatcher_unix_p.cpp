...
static const char qt_meta_stringdata_QEventDispatcherUNIX[] = {
    "QEventDispatcherUNIX\0"
};
...
const QMetaObjectExtraData QEventDispatcherUNIX::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QEventDispatcherUNIX::staticMetaObject = {
    { &QAbstractEventDispatcher::staticMetaObject, qt_meta_stringdata_QEventDispatcherUNIX,
      qt_meta_data_QEventDispatcherUNIX, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QEventDispatcherUNIX::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QEventDispatcherUNIX))
