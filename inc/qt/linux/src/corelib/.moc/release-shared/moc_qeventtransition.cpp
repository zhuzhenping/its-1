...
const QMetaObjectExtraData QEventTransition::staticMetaObjectExtraData = {
    qt_meta_extradata_QEventTransition,  qt_static_metacall 
};
...
const QMetaObject QEventTransition::staticMetaObject = {
    { &QAbstractTransition::staticMetaObject, qt_meta_stringdata_QEventTransition,
      qt_meta_data_QEventTransition, &staticMetaObjectExtraData }
};
