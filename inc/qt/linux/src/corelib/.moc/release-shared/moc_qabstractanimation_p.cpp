...
static const char qt_meta_stringdata_QDefaultAnimationDriver[] = {
    "QDefaultAnimationDriver\0"
};
...
const QMetaObjectExtraData QDefaultAnimationDriver::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QDefaultAnimationDriver::staticMetaObject = {
    { &QAnimationDriver::staticMetaObject, qt_meta_stringdata_QDefaultAnimationDriver,
      qt_meta_data_QDefaultAnimationDriver, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDefaultAnimationDriver::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDefaultAnimationDriver))
