...
const QMetaObjectExtraData QSharedMemory::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QSharedMemory::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QSharedMemory,
      qt_meta_data_QSharedMemory, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QSharedMemory::getStaticMetaObject() { return staticMetaObject; }
